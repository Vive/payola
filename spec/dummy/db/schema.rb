...
ActiveRecord::Schema.define(version: 20_151_104_192_336) do
  ...
  add_index 'payola_sales', %w(owner_id owner_type), name: 'index_payola_sales_on_owner_id_and_owner_type'
  add_index 'payola_sales', %w(product_id product_type), name: 'index_payola_sales_on_product'
